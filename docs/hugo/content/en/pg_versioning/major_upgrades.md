...
{{< hint type=info >}}Note that an in-place upgrade generates both a pod restart in the form of a rolling update and an operational interruption of the cluster during the actual execution of the restore.{{< /hint >}}
