...
func (c *Cluster) getPatroniConfig(pod *v1.Pod) (cpov1.Patroni, map[string]string, error) {
	var (
	...
	if err != nil {
		return cpov1.Patroni{}, nil, fmt.Errorf("could not get Postgres config from pod %s: %v", podName, err)
	}
