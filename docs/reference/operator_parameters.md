...
* ConfigMaps-based, the legacy one.  The configuration is supplied in a
  ...
  [example](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/configmap.yaml)
...
* CRD-based configuration. The configuration is stored in a custom YAML
  ...
  start and uses it for configuration if the [operator deployment manifest](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/postgres-operator.yaml#L36)
  ...
  the [default one](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/postgresql-operator-default-configuration.yaml)
  and change it.
...
For the configmap configuration, the [default parameter values](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/pkg/util/config/config.go#L14)
...
[operator's default configuration manifest](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/postgresql-operator-default-configuration.yaml)
...
* **set_memory_request_to_limit**
  ...
  **sidecars** defined in the operator configuration); to set resources for the
  operator's own container, change the [operator deployment manually](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/postgres-operator.yaml#L20).
  The default is `false`.
...
* **pod_service_account_role_binding_definition**
  ...
  account to the 'postgres-pod' [cluster role](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/manifests/operator-service-account-rbac.yaml#L198)
...
* **logical_backup_docker_image**
  An image for pods of the logical backup job. The [example image](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc3/blob/master/docker/logical-backup/Dockerfile)
