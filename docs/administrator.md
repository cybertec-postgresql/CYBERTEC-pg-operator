...
the `POSTGRES_OPERATOR_CONFIGURATION_OBJECT` [environment variable](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/postgres-operator.yaml#L36)
...
manifests of [`postgresql`](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/postgresql.crd.yaml) or [`OperatorConfiguration`](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/operatorconfiguration.crd.yaml)
...
```
where `N` is the number of members of your cluster (see [`numberOfInstances`](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/50cb5898ea715a1db7e634de928b2d16dc8cd969/manifests/minimal-postgres-manifest.yaml#L10)).
...
cluster role bindings in [operator RBAC rules](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/operator-service-account-rbac.yaml)
...
[operator deployment](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/postgres-operator.yaml) manifest or by
altering the `watched_namespace` field in the operator
[configuration](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/postgresql-operator-default-configuration.yaml#L49).
...
First, define the [`CONTROLLER_ID`](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/postgres-operator.yaml#L38)
...
metadata:
  name: demo-cluster
  annotations:
    "cpo.opensource.cybertec.at/controller": "second-operator"
spec:
  ...
```
...
The manifest [`operator-service-account-rbac.yaml`](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/operator-service-account-rbac.yaml)
...
downtime. See PR [#384](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/pull/384)
for the use case.
...
2. The [example image](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/docker/logical-backup/Dockerfile) implements the backup
...
See [example RBAC](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/operator-service-account-rbac.yaml)
...
environment variables in the [deployment manifest](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/ui/manifests/deployment.yaml#L40).
You can also expose the operator API through a [service](https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/manifests/api-service.yaml).
