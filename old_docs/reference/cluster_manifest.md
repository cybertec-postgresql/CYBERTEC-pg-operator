...
[minimal](https://github.com/cybertec-postgresql/cybertec-pg-operator/blob/master/manifests/minimal-postgres-manifest.yaml)
and the
[complete](https://github.com/cybertec-postgresql/cybertec-pg-operator/blob/master/manifests/complete-postgres-manifest.yaml)
cluster manifests.
...
* **usersWithSecretRotation**
  ...
  details in the [administrator docs](https://github.com/cybertec-postgresql/cybertec-pg-operator/blob/master/docs/administrator.md#password-rotation-in-k8s-secrets).
...
* **usersWithInPlaceSecretRotation**
  ...
  details in the [administrator docs](https://github.com/cybertec-postgresql/cybertec-pg-operator/blob/master/docs/administrator.md#password-replacement-without-extra-users).
...
* **serviceAnnotations**
  ...
  [administrator docs](https://github.com/cybertec-postgresql/cybertec-pg-operator/blob/master/docs/administrator.md#load-balancers-and-allowed-ip-ranges)
