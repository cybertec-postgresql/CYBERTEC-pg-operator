...
DEFAULT_UI_CONFIG = {
    'docs_link': 'https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI',
...
# See https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0_changeAPI/blob/master/pkg/cluster/cluster.go  # noqa
