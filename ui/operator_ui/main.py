...
DEFAULT_UI_CONFIG = {
    'docs_link': 'https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc5',
...
# See https://github.com/cybertec-postgresql/CYBERTEC-pg-operator/tree/v0.7.0-rc5/blob/master/pkg/cluster/cluster.go  # noqa
