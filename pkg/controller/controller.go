...
import (
	...
	cpov1.nformer "github.com/cybertec-postgresql/cybertec-pg-operator/pkg/generated/informers/externalversions/cpo.opensource.cybertec.at/v1"
...
func (c *Controller) initSharedInformers() {
	...
	// Postgresqls
	c.postgresqlInformer = cpov1.nformer.NewPostgresqlInformer(
	...
	// PostgresTeams
	if c.opConfig.EnablePostgresTeamCRD {
		c.postgresTeamInformer = cpov1.nformer.NewPostgresTeamInformer(
			c.KubeClient.CpoV1ClientSet,
			c.opConfig.WatchedNamespace,
